...
# options passed:  -imultiarch x86_64-linux-gnu user_agent3.c
...
# user_agent3.c:11: 	assert(hdr_value != NULL);
...
.L2:
# user_agent3.c:12: 	const size_t name_len = strlen(USER_AGENT_HDR_NAME);
	movq	$12, -24(%rbp)	#, name_len
# user_agent3.c:13: 	const size_t value_len = strlen(hdr_value);
	movq	-40(%rbp), %rax	# hdr_value, tmp88
	movq	%rax, %rdi	# tmp88,
	call	strlen@PLT	#
	movq	%rax, -16(%rbp)	# tmp89, value_len
# user_agent3.c:14: 	char *hdr = malloc(sizeof(char) * (name_len + value_len + 1));
	movq	-24(%rbp), %rdx	# name_len, tmp90
	movq	-16(%rbp), %rax	# value_len, tmp91
	addq	%rdx, %rax	# tmp90, _2
# user_agent3.c:14: 	char *hdr = malloc(sizeof(char) * (name_len + value_len + 1));
	addq	$1, %rax	#, _3
	movq	%rax, %rdi	# _3,
	call	malloc@PLT	#
	movq	%rax, -8(%rbp)	# tmp92, hdr
# user_agent3.c:16: 	if (hdr)
	cmpq	$0, -8(%rbp)	#, hdr
	je	.L3	#,
# user_agent3.c:17: 		sprintf(hdr, "%s%s", USER_AGENT_HDR_NAME, hdr_value);
	leaq	.LC0(%rip), %rsi	#, USER_AGENT_HDR_NAME.1_4
	movq	-40(%rbp), %rdx	# hdr_value, tmp93
	movq	-8(%rbp), %rax	# hdr, tmp94
	movq	%rdx, %rcx	# tmp93,
	movq	%rsi, %rdx	# USER_AGENT_HDR_NAME.1_4,
	leaq	.LC3(%rip), %rsi	#,
	movq	%rax, %rdi	# tmp94,
	movl	$0, %eax	#,
	call	sprintf@PLT	#
.L3:
# user_agent3.c:18: 	return hdr;
