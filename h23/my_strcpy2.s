...
# options passed:  -imultiarch x86_64-linux-gnu my_strcpy2.c -mtune=generic
...
# my_strcpy2.c:6: 	__asm__ __volatile__(
	movq	-16(%rbp), %rax	# src, tmp84
	movq	-8(%rbp), %rdx	# dest, tmp85
	movq	%rax, %rsi	# tmp84, tmp84
...
# 6 "my_strcpy2.c" 1
	...
	jne 1b
# 0 "" 2
# my_strcpy2.c:13: 	return dest ;
#NO_APP
	movq	-8(%rbp), %rax	# dest, _5
# my_strcpy2.c:14: }
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret	
...
# my_strcpy2.c:17: {
	...
	xorl	%eax, %eax	# tmp87
# my_strcpy2.c:19: 	strcpy( buf, "copied sring by my_strcpy" ) ;
	leaq	-112(%rbp), %rax	#, tmp84
	leaq	.LC0(%rip), %rsi	#,
	movq	%rax, %rdi	# tmp84,
	call	strcpy	#
# my_strcpy2.c:20: 	printf( "%s\n", buf ) ; 
	leaq	-112(%rbp), %rax	#, tmp85
	movq	%rax, %rdi	# tmp85,
	call	puts@PLT	#
# my_strcpy2.c:21: 	return 0 ;
	movl	$0, %eax	#, _4
# my_strcpy2.c:22: }
