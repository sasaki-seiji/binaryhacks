...
# options passed:  -imultiarch x86_64-linux-gnu heapexec3.c -mtune=generic
...
# heapexec3.c:16: 	long pagesize = (int)sysconf(_SC_PAGESIZE) ;
	movl	$30, %edi	#,
	call	sysconf@PLT	#
# heapexec3.c:16: 	long pagesize = (int)sysconf(_SC_PAGESIZE) ;
	cltq
	movq	%rax, -16(%rbp)	# tmp89, pagesize
# heapexec3.c:17: 	char *p = (char *)((long)addr & ~(pagesize - 1)) ;
...
# heapexec3.c:17: 	char *p = (char *)((long)addr & ~(pagesize - 1)) ;
	movq	%rax, -8(%rbp)	# _5, p
# heapexec3.c:18: 	mprotect(p, pagesize * 10L, PROT_READ | PROT_WRITE | PROT_EXEC) ;
...
.LFB8:
	...
	.cfi_def_cfa_register 6
	subq	$16, %rsp	#,
# heapexec3.c:23: 	void *p = malloc(1000);
	movl	$1000, %edi	#,
	call	malloc@PLT	#
	movq	%rax, -8(%rbp)	# tmp86, p
# heapexec3.c:24: 	memcpy(p, func, 1000);
	movq	-8(%rbp), %rax	# p, tmp87
	movl	$1000, %edx	#,
	leaq	func(%rip), %rsi	#,
	movq	%rax, %rdi	# tmp87,
	call	memcpy@PLT	#
# heapexec3.c:25: 	allow_execution(p);
	movq	-8(%rbp), %rax	# p, tmp88
	movq	%rax, %rdi	# tmp88,
	call	allow_execution	#
# heapexec3.c:26: 	printf("PI equals to %d\n", ((int(*)(void))p)()) ; 
